...
namespace CanamLiveFA.DO
{
    public class User
    {
        ...
        public void PopulateUser(int UserId, string userName, Enums.Team team, double bidFeesPayable, double bidFeesRecievable, string password, bool commissioner)
        {
            m_UserId = UserId;
            m_UserName = userName;
            m_Team = team;
            m_BidFeesPayable = bidFeesPayable;
            m_BidFeesReceivable = BidFeesReceiveable;
            m_Password = password;
